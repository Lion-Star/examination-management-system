        ...
        <div class="box2-list2">
            ...
            <p>
                <el-select v-if="addType" v-model="exam_id" placeholder="请选择">
                    <el-option v-for="item in addType" :key="item.value" :label="item.exam_name" :value="item.exam_id"></el-option>
                </el-select>
            </p>
        </div>
        <div class="box2-list3">
            ...
            <p>
                <el-select v-model="subject_id" placeholder="请选择">
                    <el-option v-for="item in addClass" :key="item.value" :label="item.subject_text" :value="item.subject_id"></el-option>
                </el-select>
            </p>
        </div>
        ...
        <div class="last">
            ...
            <div class="box2-list5">
                <div class="block">
                    ...
                    <el-date-picker v-model="start_time" type="date" placeholder="开始日期" value-format="timestamp">
                    </el-date-picker>
                </div>
                <div class="block">

                    <el-date-picker v-model="end_time" type="date" placeholder="结束日期" value-format="timestamp">
                    </el-date-picker>
                </div>
            </div>
        </div>
