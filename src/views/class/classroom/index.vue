...
<el-container>
    ...
    <el-main style="display: flex;flex-direction: column;">
        <el-table :data="roomList" style="width: 100%;flex:1;" :header-cell-style="{background:'#f4f4f4',color:'#555',lineHeight:'20px',fontSize:'14px'}">
            <el-table-column label="教室名">
