...
export const authorityRoutes = [{
    ...
    },
    {
        path: '/addUser',
        component: Layout,
        meta: { title: 'user.title', icon: 'user', noCache: true },
        children: [{
            path: 'addUser',
            component: () =>
                import ('@/views/user/addUser'),
            name: 'AddUser',
            meta: { title: 'user.addUser', view_id: "main-addUser" } // 添加用户
        }, {
            path: 'usershow',
            component: () =>
                import ('@/views/user/usershow'),
            name: 'Usershow',
            meta: { title: 'user.usershow', view_id: "main-showUser" } // 用户展示
        }, {
            path: 'GGBOND',
            // hidden:true,
    ...
    },
    {
        path:"/student",
        component:Layout,
        meta: { title: 'student.title', icon: 'people', noCache: true },
        children:[{
            path:"student",
            component:()=>import("@/views/student/menage"),
            name:"Student",
            meta: { title: 'student.student', view_id: "main-addUser" }
        },{
            path:"menage",
            component:()=>import("@/views/student/menage"),
            name:"Menage",
            meta: { title: 'student.manege', view_id: "main-addUser" }
        }]
    },
    {
        path: '/class',
