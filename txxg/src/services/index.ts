...
const factHost='//fact.txxg.jasonandjay.com';
const apiHost='//api.txxg.jasonandjay.com';
const wechatHost='//wechat.txxg.jasonandjay.com';
const inewsHost='http://view.inews.qq.com';
// 获取全国省份列表
